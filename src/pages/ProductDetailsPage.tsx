      ...
      <section className="pdp-info-cards-section">
        <div className="pdp-info-cards-grid">
          <div className="pdp-info-card">
            ...
            <h4>BEST OFFERS</h4>
            <ul>
              <li>Applicable on: Orders above Rs. 300<br/>(only on first purchase)</li>
              <li>Coupon code: MYNTRAEXCLUSIVE1</li>
              <li>Coupon Discount: 30% off (Your total<br/>saving: Rs. 373)</li>
            </ul>
          </div>
          <div className="pdp-info-card">
            <div className="pdp-card-icon">
